                ...
                <form className="formAgregarInstituto p-3 needs-validation" noValidate id="formAgregarInstituto"
                    ...
                    <div className="nombres mb-3">
                        <div className="nombre me-3">
                            <label htmlFor="name" className="form-label">Nombre de la institución<span
                        ...
                        <div>
                            <label htmlFor="abbreviation" className="form-label">Abreviatura<span style="color: red;">*</span></label>
                            <div className="">
                    ...
                    <div className="">
                        <label htmlFor="year_fundation" className="form-label">Año de fundación<span
                            style="color: red;">*</span></label>
