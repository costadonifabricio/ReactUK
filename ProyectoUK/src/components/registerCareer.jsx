        ...
        <>
            <main className="bg-success">
                <form className="formAgregarCarrera p-3" id="formAgregarCarrera">
                    <h2 className="mb-3 text-center">Agrega una nueva carrera</h2>
                    <div className="mb-3">
                        <label htmlFor="facultad" className="form-label">Facultad de la carrera<span
                            style="color: red;">*</span></label>
                        <input type="text" placeholder="Facultad de **** " className="form-control" id="facultad" />
                    </div>
                    <label htmlFor="name" className="form-label">Nombre de la carrera<span style="color: red;">*</span></label>
                    <div className="mb-3">
                    ...
                    <div className="mb-3 apartado2">
                        <div className="me-3 start_date">
                            <label htmlFor="start_date" className="form-label">Fecha de inicio<span style="color: red;">*</span></label>
                            <input type="date" className="form-control" id="start_date" />
                        </div>

                        <div className="me-3 duracion">
                            <label htmlFor="duration" className="form-label">Duración<span style="color: red;">*</span></label>
                    ...
                    <div className="mb-3">
                        <label htmlFor="finalTitle" className="form-label">Título final <span
                            style="color: red;">*</span></label>
